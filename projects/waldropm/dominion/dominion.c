...
//      discardCard(handPos, currentPlayer, state, 0);
//      return 0;
		return villageRefactor(&currentPlayer, state, &handPos);
...
//      
//      return 0;
		return baronRefactor(state, &choice1, &currentPlayer);
...
//      discardCard(handPos, currentPlayer, state, 0);
//      return 0;
		return greatHallRefactor(&currentPlayer, state, &handPos);
